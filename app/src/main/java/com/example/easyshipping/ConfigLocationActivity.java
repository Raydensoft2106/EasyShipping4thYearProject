...
public class ConfigLocationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userEmail=getIntent().getStringExtra("email");//from intent
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                LocationResultHelper helper = new LocationResultHelper(ConfigLocationActivity.this, locations);
