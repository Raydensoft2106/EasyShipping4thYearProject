...
public class PermissionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(PermissionsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            Intent rIntent = new Intent(PermissionsActivity.this, RouteMapActivity.class);
            rIntent.putExtra("userID",userID);
            rIntent.putExtra("depot",depot);
            rIntent.putExtra("driverEmail",driverEmail);
            rIntent.putExtra("DriverName", DriverName);
                ...
                Dexter.withActivity(PermissionsActivity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                startActivity(new Intent(PermissionsActivity.this, RouteMapActivity.class));
                                finish();
                            }
