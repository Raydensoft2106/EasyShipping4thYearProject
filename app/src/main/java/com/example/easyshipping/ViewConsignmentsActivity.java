...
public class ViewConsignmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(ViewConsignmentsActivity.this);
        ...
        downloadJSON("https://easyshippingrh.000webhostapp.com/listConsignments.php?receiver_id="+userID);
